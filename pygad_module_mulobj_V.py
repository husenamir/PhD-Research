...
def fitness_func(ga_instance, solution, solution_idx):
    ...
    fitness1= 1.0/(1 + total)
    
    fitness2 = 1.0/(1 + abs(freqs[0]))
    ...
    fitness4 = 1.0/(1 + len(neg_freqs)*1000)
...
if __name__ == '__main__':
    ...
    gene_space = [{'low': 7, 'high': 10}, {'low': -2.00, 'high': 1.00}, {'low': -2.00, 'high': 1.00}, {'low': -2.00, 'high': 1.00}, {'low': -2.00, 'high': 1.00}]
    ...
    # Plot the evolution
    ga_instance.plot_fitness(label=['Fitness1', 'Fitness2', 'Fitness3', 'Fitness4'])
