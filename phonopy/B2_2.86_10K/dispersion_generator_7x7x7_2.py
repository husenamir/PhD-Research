...
root = 'B2_2.88_1500K'
alat = 2.88 * 6 # Lattice parameter times number of unit cells (so the size of the box)
ndisps = 499 # Number of dispersions to generate (equal to number of yalm files)
