...
# -*- coding: utf-8 -*-
"""
Created on Sat May  4 16:58:55 2024
...
#init_file_number = 0#994
ndisps = 1#5
root = 'B2_2.86_10K'
alat = 1 # Lattice parameter times number of unit cells (so the size of the box)
n = 250 # Number of atoms
init_no = 0 #3400
#par_dir = "C:\\Users\\biknb\\Downloads\\amir\\"
#parent_dir = par_dir + "0GPa\\"
#in_path = parent_dir + 'LAMMPS\\NVT\\Fe_'+root+'/'
...
in_filename = '250_ideal'
# in_filename = 'ideal_Fe_'+root+'_unit.txt' # Modify pos file
ide_lat = np.genfromtxt(in_path+in_filename)
ide_lat = ide_lat[:250, 1:]
...
#fc_filename = 'fc_Fe_2.86_10K_bkc.csv'
#fc_per_ts_df = pd.read_csv(fc_in_path+fc_filename, skiprows=390, header=None) #skiprows=5
